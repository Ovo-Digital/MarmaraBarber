...
import { storefrontAuthHeaders } from "@/lib/shopify-client";
...
export function createShopifyServerClient() {
  ...
  const apiVersion = process.env.SHOPIFY_API_VERSION ?? process.env.NEXT_PUBLIC_SHOPIFY_API_VERSION ?? "2026-07";
